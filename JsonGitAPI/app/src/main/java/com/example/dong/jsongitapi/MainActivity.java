...
public class MainActivity extends AppCompatActivity {
    ...
    private ILoadData mIloadData = new ILoadData() {
        @Override
        public void loadData(List<ItemGit> itemGits) {
            mDataAdapter = new DataAdapter(getBaseContext(), itemGits);
        ...
        if (currentAPIVersion >= android.os.Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.INTERNET)) {
                    showDialog(Constants.MESSAGE, this, Manifest.permission.INTERNET);
                } else {
                    ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.INTERNET}, Constants.REQUEST_CODE);
                }
            } else {
                setComponent();
            }
